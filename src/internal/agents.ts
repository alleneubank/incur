...
/**
 * All known agent definitions. Paths are resolved from the environment on every call, so a `HOME` or
 * config directory set after import (as tests and embedding CLIs do) is honored.
 */
export function all(): Agent[] {
