...
- a0c90a4: Report command-line parser failures with the machine-readable `INVALID_ARGUMENT` code.
...
- d07b3bb: Rebase the fork onto upstream `wevm/incur` at `abd9af3` (upstream 0.4.26).
